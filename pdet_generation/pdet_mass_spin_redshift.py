...
def fraction_above_threshold(
    ...
    rho_max = optimal_snr(
        m1, m2, a1z, a2z, z, fmin, dfmin, fref, psdstart, psd_fn, approximant
    )
...
def pdets_from_masses_spins(
    ...
    args = [
        (m1, m2, a1, a2, z, thresh, 19.0, 0.0, 40.0, 20.0, psd_fn, waveform)
...
def main():
    samples = 200000
    output = "./pdet_with_mass_spin.hdf5"
    ...
    pdets = pdets_from_masses_spins(m1s, m2s, a1zs, a2zs, zs, 8.0)
    ...
    with h5py.File(output, "w") as f:
        ...
        f.attrs["description"] = (
            ...
            "with uniform priors in mass, spin and redshift. "
